...
const pixCheckbox = document.querySelector("#PIX")
const DINHEIROCheckbox = document.querySelector("#DINHEIRO")
const CARTAOCheckbox = document.querySelector("#CARTAO")
...
checkout.addEventListener("click", () => {
  ...
  const pagamentoSelecionados = [];
  if (pixCheckbox.checked) {
    pagamentoSelecionados.push(pixCheckbox.value);
  }
  if (DINHEIROCheckbox.checked) {
    pagamentoSelecionados.push(DINHEIROCheckbox.value);
  }
  if (CARTAOCheckbox.checked) {
    pagamentoSelecionados.push(CARTAOCheckbox.value);
  }
  ...
  const saboresMensagem = pagamentoSelecionados.length > 0 
  ? ` Pagamento selecionado: ${pagamentoSelecionados.join(", ")} \n` 
  : "\n";
